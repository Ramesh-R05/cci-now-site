...
describe('FooterColumn', () => {
    describe('rendering', () => {
        ...
        describe('with valid props', () => {
            ...
            before(() => {
                [wrapper, testProps] = TestWrapper({
                    ...
                    spanLarge: 6,
                    spanxLarge: 8,
                    children: [<div key={1}>A child element</div>]
                });
            });
        ...
        describe('with renderChildrenInList prop passed', () => {
            ...
            before(() => {
                [wrapper, testProps] = TestWrapper({
                    ...
                    children: [<li key={1}>A list item</li>, <li key={2}>A list item</li>, <li key={3}>A list item</li>, <li key={4}>A list item</li>]
                });
            });
        ...
        describe('without the titleText prop and with children', () => {
            ...
            before(() => {
                [wrapper, testProps] = TestWrapper({ children: [<div key={1}>A child element</div>] });
            });
