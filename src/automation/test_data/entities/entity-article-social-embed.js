export default {
    id: 'NOW-31891',
    url: '/fashion/red-carpet/automation-test-article-with-social-embed-3662',
    contentTitle: 'Automation Test Article With Hero Image Test Title Long Title Long Title Long Title Long Title EOM',
    contentBody: [
        {
            type: 'paragraph',
            label: 'Paragraph',
        ...
        { type: 'heading', label: 'Heading', content: 'Test body heading body heading body heading body heading body heading EOM' },
        {
            type: 'image',
            label: 'Image',
            content: {
        ...
        { type: 'twitter', label: 'Twitter', content: { url: 'https://twitter.com/dollymag/status/697199025729048577' } },
        { type: 'instagram', label: 'Instagram', content: { url: 'https://www.instagram.com/p/BBda49yyr4J/', includeCaption: true } },
        { type: 'instagram', label: 'Instagram', content: { url: 'https://www.instagram.com/p/BA4NkZeSr_r/' } },
        { type: 'facebook', label: 'Facebook', content: { url: 'https://www.facebook.com/Foodtoloveau/posts/823515874446034' } },
        { type: 'playbuzz', label: 'Playbuzz', content: { game: '/cosmopolitanmagazine10/which-harry-styles-is-your-boyfriend' } },
        { type: 'youtube', label: 'Youtube', content: { url: 'https://www.youtube.com/embed/4GpnNxjy6m0' } },
        { type: 'vimeo', label: 'Vimeo', content: { url: 'https://player.vimeo.com/video/181027959' } },
        { type: 'whooshka', label: 'Whooshka', content: { url: 'https://www.whooshkaa.com/player/episode/id/90704?visual=true' } },
        { type: 'wirewax', label: 'Wirewax', content: { url: 'https://embed.wirewax.com/8037657/ff0044/' } },
        { type: 'giphy', label: 'Giphy', content: { id: 'sLs8Ll8Qx51xm' } },
        { type: 'linklay', label: 'Linklay', content: { url: 'https://www.linklay.com/app/linklay/embed/linklay59151f750e2a94.81058944' } },
        {
            type: 'image-revealer',
    ...
    contentImageUrl: 'https://d3lp4xedbqa8a5.cloudfront.net/s3/digital-cougar-assets/now/2017/10/03/1506982363142_test-main-image.jpg',
    contentCampaign: [],
