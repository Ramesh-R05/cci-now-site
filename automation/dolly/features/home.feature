...
Feature: Homepage
    ...
    @trending @DD0-69
    Scenario: Verify the trending element is functional correctly in mobile view
        Given I am currently viewing the homepage
        When I switch to "mobile" view
        * I should see the trending title at the top
        * I should see the trending background image
        * I should see 2 items in the trending
        * Image and title of all items are clickable

    @trending @DD0-69
    Scenario: Verify the trending element is functional correctly in tablet portrait view
        Given I am currently viewing the homepage
        When I switch to "tablet portrait" view
        * I should see the trending title at the top
        * I should see the trending background image
        * I should see 3 items in the trending
        * Image and title of all items are clickable

    @trending @DD0-69
    Scenario: Verify the trending element is functional correctly in tablet landscape view
        Given I am currently viewing the homepage
        When I switch to "tablet landscape" view
        * I should see the trending title at the top
        * I should see the trending background image
        * I should see 5 items in the trending
        * Image and title of all items are clickable

    @trending @DD0-69
    Scenario: Verify the trending element is functional correctly in desktop view
        Given I am currently viewing the homepage
        When I switch to "desktop" view
        * I should see the trending title in the left hand side
        * I should see the trending background image
        * I should see 5 items in the trending
        * Image and title of all items are clickable
    ...
    Scenario: Verify the hero teaser element is functional correctly in mobile view
        ...
        * The homepage hero image should be clickable to open its page
        #* I should see the homepage hero info appearing under hero image on "mobile"
    ...
    Scenario: Verify the hero teaser element is functional correctly in tablet portrait view
        ...
        * I should see the homepage hero image
        * The homepage hero image should be clickable to open its page
        #* I should see the homepage hero info appearing in the right side on "tablet portrait"
    ...
    Scenario: Verify the hero teaser element is functional correctly in tablet landscape view
        ...
        * I should see the homepage hero image
        * The homepage hero image should be clickable to open its page
        #* I should see the homepage hero info appearing under hero image on "tablet landscape"
        * I should see the homepage hero custom label at the bottom edge of hero image
        * I should see the homepage hero title
        * The homepage hero title should be clickable to open its page
        * I should see the homepage hero short teaser
    ...
    Scenario: Verify the hero teaser element is functional correctly in desktop view
        ...
        * I should see the homepage hero image
        * The homepage hero image should be clickable to open its page
        #* I should see the homepage hero info appearing in the right side on "desktop"
        * I should see the homepage hero custom label in the right side
        * I should see the homepage hero title
        * The homepage hero title should be clickable to open its page
        * I should see the homepage hero short teaser
    ...
    @homepagefeed @DDO-235
    Scenario: Verify the news feed is functional correctly in tablet portrait view
        Given I am currently viewing the homepage
        When I switch to "tablet portrait" view
        * I should see 7 top half feed
        * I should see each top feed item containing images
    ...
    @homepagefeed @DDO-235
    Scenario: Verify the news feed is functional correctly in tablet landscape view
        Given I am currently viewing the homepage
        When I switch to "tablet landscape" view
        * I should see 7 top half feed
        * I should see each top feed item containing images
    ...
    @homepagefeed @DDO-235
    Scenario: Verify the news feed is functional correctly in desktop view
        Given I am currently viewing the homepage
        When I switch to "desktop" view
        * I should see 7 top half feed
        * I should see each top feed item containing images
    ...
    @homepagefeed-bottom @DDO-234
    Scenario Outline: Verify the homepage bottom half news feed is functional correctly in desktop view
        Given I am currently viewing the homepage
