var article_widget = {
    ...
    heroVideoPlaylist: '.article__main-hero-video .video-playlist-container',
    heroVideoPlaylistItem: '.article__main-hero-video .vjs-playlist-loaded li',
    heroVideoPlaylistThumbnail: '.article__main-hero-video .video-playlist-container .vjs-playlist-item img',
    heroVideoPlaylistTitle: '.article__main-hero-video .video-playlist-container .vjs-playlist-name',
    heroVideoPlayButton: '.article__main-hero-video button.vjs-big-play-button',
    heroVideoControlBar: '.article__main-hero-video .vjs-control-bar button',
    heroVideoProgress: '.article__main-hero-video .vjs-progress-control .vjs-slider-horizontal',
    ...
    lhrFeedItems: '.feed__container li.feed-item',
    lhrFeedTitles: '.feed__container li.feed-item:nth-child(1) a.feed-item__body-title',
    lhrFeedImgs: '.feed__container a.teaser__image',
    lhrOneFeedImgs: '.feed__container li.feed-item:nth-child(1) a.teaser__image',
    lhrFeed: '.feed',
    lhrFeedSource: '.feed__container li.feed-item:nth-child(1) .feed-item__source',
